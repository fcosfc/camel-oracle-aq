package com.wordpress.fcosfc.camel.oracle.aq;
...
/**
 * Dummy Camel Processor that simulates msg processing. Increments a static
 * counter for each msgs received.
 *
 * Can also be used to raise an exception for every X msg to illustrate how an
 * exception causes the transaction to be rolled back.
 *
 */
